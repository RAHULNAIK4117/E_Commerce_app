    ...
    <header className="bg-white shadow-sm sticky top-0 left-0 w-full z-50">
      <div className=" w-full flex items-center justify-between py-3 px-10">
        ...
        <div className="flex items-center gap-2">
          <Button onClick={()=>navigate("/wish-list")} sx={{ textTransform: "capitalize" }}
            variant="text"
            color="black" className="relative cursor-pointer flex">
          ...
          <Button onClick={()=>navigate("/cart")}  sx={{ textTransform: "capitalize" }}
            variant="text"
            color="black" className="relative cursor-pointer flex">
